...
function Id(props) {
  ...
  return (
    <PrincipalLayout title={"Ver cliente"}>
      {/* Create form */}
      <ErrorModal 
      ...
      >
        {({errors}) => (
          ...
          style={{width: "100%", display: "flex", flexDirection: "column", gap: "12px"}}>
            ...
            <TextField title={"Nombres"} type={"text"} name={"name"} readOnly={true}/>
            <TextField title={"Apellidos"} type={"text"} name={"lastname"} readOnly={true}/>
            <TextField
